                ...
                <div className="modal-box">
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-0'>
                        <div className="form-control">
                            ...
                            <input name="item" type="text" disabled value="" className="input w-full input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control">
                            ...
                            <input name="price" type="text" disabled value="" className="input w-full input-bordered" />
                        </div>     
